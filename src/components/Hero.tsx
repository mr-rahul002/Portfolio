    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 text-center z-10">
        <div className="max-w-3xl mx-auto">
          ...
          >
            Dynamic Software Development Professional with expertise in building user-centric solutions
          </p>
          ...
          >
            <a 
              href="mailto:r07rahulseth@gmail.com" 
            ...
            <a 
              href="#projects" 
              className="px-6 py-3 rounded-full border border-black hover:bg-black hover:text-white transition-all duration-300 ease-in-out"
            >
              View Projects
            </a>
          </div>
